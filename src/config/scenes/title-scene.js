...
export default {
    ...
    layers: [{
        ...
        components: [DelayInputs, {
            ...
            entities: [
                {type: "🤔", properties: {inputDelay: -250, interpolation: 125, x: -300, y: -300}},
                {type: "🤔", properties: {inputDelay: -250, interpolation: 75, x: -300, y: 0}},
                {type: "🤔", properties: {inputDelay: -250, interpolation: 25, x: -300, y: 300}},
                {type: "🤔", properties: {inputDelay: -150, interpolation: 125, x: 0, y: -300}},
                {type: "🤔", properties: {inputDelay: -150, interpolation: 75, x: 0, y: 0}},
                {type: "🤔", properties: {inputDelay: -150, interpolation: 25, x: 0, y: 300}},
                {type: "🤔", properties: {inputDelay: -50, interpolation: 125, x: 300, y: -300}},
                {type: "🤔", properties: {inputDelay: -50, interpolation: 75, x: 300, y: 0}},
                {type: "🤔", properties: {inputDelay: -50, interpolation: 25, x: 300, y: 300}},
                {type: "🗿"},
                {type: "🗿"},
                {type: "🗿"},
                {type: "🗿"},
